      ...
      <table class="table table-bordered table-striped">
        ...
        <?php foreach($all_users as $a_user): ?>
          <tr>
                ...
                <td>
                  <?php if($a_user['image'] === '0'): ?>
                    <img class="img-avatar img-circle" src="uploads/users/no_image.jpg" alt="">
                  <?php else: ?>
                  <img class="img-avatar img-circle" src="uploads/users/<?php echo $a_user['image']; ?>" alt="">
                <?php endif; ?>
                </td>
          ...
          <?php endif;?>
           ...
           <td class="text-center">
              ...
              <?php if($a_user['username'] != $user['username']) { 
                  // condicional par eliminar usuario?>
